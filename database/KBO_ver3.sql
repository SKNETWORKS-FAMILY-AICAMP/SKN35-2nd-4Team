...
COMMENT ON COLUMN "player_season"."n_stint" IS ''소속팀 수';
...
COMMENT ON COLUMN "player_season"."y_departed" IS ''L1 이탈 여부 0.0/1.0 (nullable)';
...
COMMENT ON COLUMN "player_season"."y_returned" IS ''L3 복귀 여부 0.0/1.0 (nullable)';
...
COMMENT ON COLUMN "games"."y_home_win" IS ''홈팀 승리 여부 0.0/1.0';
...
ALTER TABLE "appearances" ADD CONSTRAINT "FK_teams_TO_appearances_1" FOREIGN KEY (
	"year"
)
REFERENCES "teams" (
	"year"
...
ALTER TABLE "appearances" ADD CONSTRAINT "FK_teams_TO_appearances_2" FOREIGN KEY (
	"team_id"
)
REFERENCES "teams" (
	"team_id"
...
ALTER TABLE "fielding_stats" ADD CONSTRAINT "FK_teams_TO_fielding_stats_1" FOREIGN KEY (
	"year"
)
REFERENCES "teams" (
	"year"
...
ALTER TABLE "pitching_stats" ADD CONSTRAINT "FK_teams_TO_pitching_stats_1" FOREIGN KEY (
	"year"
)
REFERENCES "teams" (
	"year"
...
ALTER TABLE "allstar" ADD CONSTRAINT "FK_teams_TO_allstar_1" FOREIGN KEY (
	"year"
)
REFERENCES "teams" (
	"year"
...
ALTER TABLE "batting_stats" ADD CONSTRAINT "FK_teams_TO_batting_stats_1" FOREIGN KEY (
	"year"
)
REFERENCES "teams" (
	"year"
